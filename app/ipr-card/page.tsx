...
function getIdentitySourcesFromCertificate(
  ...
  const explicitBiologicalSnapshot = getFirstNestedObjectFromSources(
    [phaseData, privateFields, certificateFields, cardFields],
  ...
  async function issueIprCardCertificate() {
    ...
    try {
      ...
      const phaseData: JsonObject = {
        ...
        privacy_boundary:
          "This is a private portable HBCE-IPR certificate downloaded by the subject. IPR Card fields and minimized identity/liveness snapshots are stored inside private_fields. Public verification must expose hash-only references, not private card fields or raw biometric media.",
        ...
        biometric_boundary:
          "The IPR Card certificate may carry minimized liveness references, hashes and verification states. It must not carry raw photos, raw videos, biometric templates or face templates."
      };
      ...
      <main className="hbce-main">
        ...
        {previousIdentitySnapshot ? (
          <section className="hbce-card hbce-card--soft">
            ...
            <h2>Biological identity ready for IPR Card issuance.</h2>

            <p>
              Certificate 08 will inherit the biological identity, physical
              descriptor profile and photo/video liveness snapshot already
              chained through the approved certificate.
            </p>
        ...
        {physicalDescriptorProfile ? (
          <section className="hbce-card hbce-card--soft">
            ...
            <h2>Physical descriptor layer ready for IPR Card.</h2>
        ...
        {biometricLivenessSnapshot ? (
          <section className="hbce-card hbce-card--soft">
            ...
            <h2>Photo/video liveness ready for IPR Card.</h2>
        ...
        {generatedCertificate ? (
          <section className="hbce-card hbce-card--success">
            ...
            <p>
              ...
              It contains IPR Card fields, inherited minimized identity/liveness
              snapshots, the corresponding hashes and the legal non-replacement
              boundary. Use this file for Phase 9 — HBCE Operational Certificate.
            </p>
